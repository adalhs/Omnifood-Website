...
////////////////////////////////////////
// Console test and small javascript test
const myName = "Adalberto Holguín";
...
btnNavElement.addEventListener("click", function () {
  headerElement.classList.toggle("nav-open"); //Without the dot because this will be added to the element in HTML
});
